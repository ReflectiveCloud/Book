# Example notebooks and code resources
...
| **GAUSS Simulations** | Working with SAI simulations stored on the Reflective Cloud Hub bucket. | AWS |
| **Pre-processed Simulations** | Guide for working with time and spatial mean post-processed data for ARISE and G6sulfur. | Cloud Hub |
